...
def extract_chip_curve(precise, rough):
    ...
    anchor = np.array([[[0, y_min]], [[x_min, h-1]]])
    ...
    hull_points = hull_points[hull_points[:, 0, 1] > 15]
    ...
    return parabola, hull_points, base_line, tool_line
...
def render_chip_curve(precise, rough, render=None):
    ...
    parabola, key_points, base_line, tool_line = extract_chip_curve(precise, rough)
